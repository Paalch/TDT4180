...
public class Main extends Application {
	...
	public Pane drawHangman() {
		...
		hangman.getChildren().add(new Arc(189, 185, 25, 25, 30, 120));
		
		  Arc arc = new Arc(189, 185, 24, 24, 30, 120);
		  arc.setFill(Color.WHITE);
		  hangman.getChildren().add(arc);
		
		//body
		hangman.getChildren().add(new Line(190,200,190,310));
		hangman.getChildren().add(new Line(190,220,240,260));
		hangman.getChildren().add(new Line(190,220,140,260));
